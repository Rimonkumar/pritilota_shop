...
const galleryImages = [
  ...
  { id: 5, url: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=800&q=80', size: 'small' },
  { id: 6, url: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=800&q=80', size: 'small' },
